...
## お知らせ
[コミュニティ](https://github.com/manju-summoner/YukkuriMovieMaker.Plugin.Community)に「縁取り（比率）」エフェクトを提案したところ、YMM4に標準搭載していただけました。よって、ゆっくりムービーメーカーv4.50.0.0以降のバージョンをお使いの方はプラグインのインストールは不要です。YMM4標準の「縁取り（比率）」エフェクトを使用してください。
